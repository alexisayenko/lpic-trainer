      ...
      {q.type === 'fill' ? (
        ...
        >
          <input
            ...
            className="w-full p-3 rounded-md border border-slate-700 bg-slate-800/60 text-slate-100 placeholder-slate-500 focus:outline-hidden focus:border-sky-600 disabled:opacity-60"
          />
        </form>
      ) : (
